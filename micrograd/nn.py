...
class Neuron:
    def __init__(self, nin):
        self.w = [Value(random.uniform(-1,1)) for _ in range(nin)]  #assigning weight per input
    ...
    def parameters(self):
        return self.w + [self.b] # casting b into a list
...
class MLP:
    def __init__(self, nin, nouts):  # nins is the number inputs, nouts is a list of layer sizes
        sz = [nin] + nouts  
